...
import java.util.HashMap;
	...
	public class EmpLinkedHash {
				public static void main(String[] args) 
				{
					HashMap<Integer, String> emp = new LinkedHashMap<Integer, String>();
					...
					HashMap<Integer, String> emp1 = new LinkedHashMap<Integer, String>();	
					emp1.put(04,"Ravi");
					emp1.put(05,"Rahul");
					emp1.put(06,"Sagar");
					System.out.println(emp1);

					HashMap<Integer, String> empFinal = new LinkedHashMap<Integer, String>();	
					empFinal.putAll(emp);
